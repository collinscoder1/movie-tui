...
export function SeasonStep({ seasons, onSelect }) {
    return (_jsxs(Box, { flexDirection: "column", paddingLeft: 4, children: [_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: 'Select season:' }) }), _jsx(SelectAll, { options: [
                    ...seasons
