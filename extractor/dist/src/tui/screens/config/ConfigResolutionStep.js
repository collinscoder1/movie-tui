...
export function ConfigResolutionStep({ onSelect }) {
    return (_jsxs(Box, { flexDirection: "column", paddingLeft: 4, children: [_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: 'Preferred resolution:' }) }), _jsx(SelectAll, { options: [
