...
export function NameStep({ isCustom, onSelect, onCustomSubmit }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", paddingLeft: 4, children: [_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: 'Choose a name:' }) }), _jsx(SelectAll, { options: [
