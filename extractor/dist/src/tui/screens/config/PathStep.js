...
export function PathStep({ isInput, onSelect, onInputSubmit }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", paddingLeft: 4, children: [_jsx(Box, { marginBottom: 1, children: _jsx(Text, { bold: true, children: 'Download path:' }) }), _jsx(Select, { options: [
