...
test('example URLs produce grouped downloads and subtitles', async () => {
  ...
  const createMockResponse = (payload: unknown): Response =>
  ...
  const urls = [
    { url: 'https://dl.vidsrc.vip/movie/tt1757678', expectedType: 'movie' as const, expectedTitle: 'Mock Movie' },
    { url: 'https://dl.vidsrc.vip/tv/tt2442560/3/2', expectedType: 'tv' as const, expectedTitle: 'Mock Series' },
    { url: 'https://dl.vidsrc.vip/tv/tt0460637/1/8', expectedType: 'tv' as const, expectedTitle: 'Mock Series' }
  ];
