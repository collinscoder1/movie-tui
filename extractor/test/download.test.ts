...
test('extract and actually download from real URLs', async (t) => {
  const urls = [
    { url: 'https://dl.vidsrc.vip/movie/tt1757678', type: 'movie' as const },
    { url: 'https://dl.vidsrc.vip/tv/tt2442560/3/2', type: 'tv' as const },
    { url: 'https://dl.vidsrc.vip/tv/tt0460637/1/8', type: 'tv' as const }
  ];
          ...
          try {
            ...
            if (reader) {
              ...
              if (!done && value) {
                ...
                if (isMp4) console.log('    Detected: MP4 container');
                if (isMkv) console.log('    Detected: MKV/WebM container');
              }
              reader.cancel();
            }
