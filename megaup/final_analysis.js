...
function analyzeMegaup() {
    ...
    if (outerIifeMatch) {
        ...
        const vmSVarName = args[0];
        const seedValue = parseInt(args[1]);
    ...
    console.log(`    1. Outer IIFE restores the vmS array using seed 0x${seedValue.toString(16)}`);
    ...
    console.log(`     2. Implement the restoration algorithm with seed 0x${seedValue.toString(16)}`);
    console.log(`     3. Apply restoration to get the true vmS array`);
    console.log(`     4. Replace all vmL(index) and hE(index) calls with actual strings`);
